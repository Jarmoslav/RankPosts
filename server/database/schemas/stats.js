...
var statsSchema = new Schema({
  ...
  topTenActiveUserPostCount: [Number],
  topTenActiveUserSentRank: [Number],
  topTenActiveUserSentScore: [Number],
  topTenActiveUserPostRank: [Number],
  topTenActiveUserPostScore: [Number],
  topTenImportantSentUserNames: [String],
  topTenImportantSentUserIDs: [Number],
  topTenImportantSentUserPostCount: [Number],
  topTenImportantSentUserRank: [Number],
  topTenImportantSentUserScore: [Number],
  topTenImportantPostUserNames: [String],
  topTenImportantPostUserIDs: [String],
  topTenImportantPostUserPostCount: [Number],
  topTenImportantPostUserRank: [Number],
  topTenImportantPostUserScore: [Number],
  keyTerms:[String]
